...
public class TreeStructureProvider implements com.intellij.ide.projectView.TreeStructureProvider {
    private final Pattern namePattern =
            Pattern.compile("(.*)\\.(client|component|service|pipe|guard|directive|actions|effects|reducer|selectors|state|resolver)\\.(css|sass|scss|stylus|styl|less|html|svg|haml|pug|spec|stories\\.ts|ts)", Pattern.CASE_INSENSITIVE);
